...
public class KafKaConsumerConfig {
   ...
   /* @Bean
    ...
    public void validateConfig() {
        Objects.requireNonNull(bootstrapServer, "kafka.consumer.bootstrap-server must be set");
        Objects.requireNonNull(groupId, "kafka.consumer.group-id must be set");

        log.info("Kafka Consumer Config loaded: bootstrap={}, groupId={}", bootstrapServer, groupId);
    }
